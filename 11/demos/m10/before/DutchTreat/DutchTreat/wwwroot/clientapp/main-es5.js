(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    function _(module, exports, __webpack_require__) {
      ...
      /*! E:\source\repos\ASP.NET Core\Building a Web App with ASP.NET Core, MVC, Entity Framework Core, Bootstrap, and Angular\aspnetcore-mvc-efcore-bootstrap-angular-web\11\demos\m10\before\DutchTreat\DutchTreat\ClientApp\main.ts */
      "QqbR");
      /***/
    },
    ...
    function BNF(module, __webpack_exports__, __webpack_require__) {
      ...
      ProductList.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 2,
        vars: 1,
        consts: [[1, "row"], ["class", "product-info col-md-4", 4, "ngFor", "ngForOf"], [1, "product-info", "col-md-4"], [1, "border", "bg-light", "rounded", "p-1", "my-1", "overflow-hidden"], [1, "img-fluid", 3, "src", "alt"], [1, "product-name"], [1, "product-props", "list-unstyled"], ["id", "buyButton", 1, "btn", "btn-success", "btn-sm", "float-right", 3, "click"]],
